...
$(function () {
    ...
    $("#content").jsGrid({
        ...
        fields: [
            ...
            { name: "dstchannel", title: "Dest. channel", type: "text", width: 100 },
            { name: "lastapp", title: "Last app", type: "text", width: 100 },
            { name: "lastdata", title: "Last data", type: "text", width: 100 },
